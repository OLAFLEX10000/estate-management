...
const Footer = () => {
  return (
    <div className='pt-10 pb-4 px-4 md:px-20 lg:px-32 bg-gray-900 overflow-hidden'>
      <div className='container mx-auto flex flex-col md:flex-row'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
            <img src={assets.logo_dark} alt="" />
            <p className='text-gray-400 mt-4'> At Estate Management, we understand that real estate is more than just buildings and land 
            it’s the foundation of security, wealth, and legacy. </p>
        </div>
      ...
      <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
        Copyright 2025 © Olaflex. All Right Reserved
      </div>
    </div>
  )
}
